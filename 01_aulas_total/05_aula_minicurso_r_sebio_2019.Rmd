...
subtitle: "<br> 5 Visualização de dados <br>"
author: "Maurício Vancine <br> Helena Oliveira <br> Lucas Almeida <br>"
date: "<br> xaringan [presentation ninja] <br> 24/10/2019"
output:
...
background-image: url(figs/saurus_plot.png)
...
```{r, include = FALSE}
library(tidyverse)
da <- read_csv("/home/mude/data/github/minicurso-r-sebio-2019/03_dados/ATLANTIC_AMPHIBIANS_sites.csv")
```
...
class: clear, center, middle
background-image: url(figs/sticker_graphics_package.png)
...
background-image: url(figs/ggplot2.png)
background-size: 500px
...
class: clear, center, middle
background-image: url(figs/ggpubr.png)
...
### Necessita de funções específicas para gerar **gráficos espacíficos**
...
background-image: url(https://rkabacoff.github.io/datavis/img/cover.png)
background-size: 230px
background-position: 50% 65%
...
background-image: url(https://www.researchgate.net/publication/319342001/figure/fig1/AS:532844527222784@1504051443243/Data-table-scatterplot.png)
background-size: 700px
background-position: 50% 50%

# 5.3 Colunas como eixos do gráficos

## Colunas se tornam eixos e valores a representação

---

background-image: url(figs/variables.png)
background-size: 700px
background-position: 50% 50%
...
background-image: url(figs/ggplot2_2.png)
background-size: 500px
background-position: 50% 50%
...
# 5.6 Gráfico de setores (pie chart)
...
# 5.6 Gráfico de setores (donut chart)
...
## O conteúdo foi **muito denso** e o **tempo foi demasiadamente curto**

--

## Peço desculpas se **algum ponto não ficou muito claro** ou se **falei rápido demais**

--

## Não deixem o **tempo passar**: começem seus estudos **agora!**

---

background-image: url(figs/ram_logo.jpg)
background-size: 600px
background-position: 50% 50%

# RAM Soluções Tecnológicas e Ambienais

<br><br><br><br><br><br><br><br><br><br><br><br><br><br><br><br><br>

https://ramambiental.com.br/
