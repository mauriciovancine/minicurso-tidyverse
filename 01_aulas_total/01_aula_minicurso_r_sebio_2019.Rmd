...
background-image: url(figs/falar_r.png)
...
background-image: url(figs/programacao.png)
background-size: 800px
background-position: 50% 75%

---

background-image: url(figs/r_funcionamento.png)
...
background-image: url(figs/r_rstudio.png)
background-size: 800px
background-position: 50% 50%
...
background-image: url(figs/site_r1.jpg)
background-size: 700px
...
background-image: url(figs/libgen_corvo.jpg)
...
background-image: url(figs/libgen1.png)
background-size: 800px
background-position: 50% 55%
...
background-image: url(figs/libgen2.png)
background-size: 800px
background-position: 50% 55%
