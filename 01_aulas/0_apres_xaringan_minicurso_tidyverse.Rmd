...
background-image: url(img/xaringan.png)

---

background-image: url(img/mauricio_vancine.jpg)
...
background-image: url(img/github_repositorio.png)
...
background-image: url(img/estrutura_dados.png)
...
5.1 Pacote broom
<br>
5.2 Modelos lineares 
<br>
5.3 Famílias de distribuição (Gaussiana, Binomial e Poisson)
<br>
5.4 Funções de ligação
<br>
5.5 Ajuste dos modelos
<br>
5.6 Avaliação do ajuste dos modelos
<br>
5.7 Seleção de modelos (AIC)
...
<br>
6.5 Renderizar um arquivo R Markdown
<br>
6.6 Estrutura do RMarkdown
<br>
6.7 Opções do chunk
<br>
6.8 Sintaxe do Markdown
<br>
6.9 Principais formatos de saída
