...
# Não confundir a **Linguagem R** com o software **RStudio**
...
background-image: url(img/person_yihui_xie.jpg)
background-size: 500px
background-position: 50% 60%
...
# É isso que faremos pelo resto da vida...
...
class: inverse, center, middle
background-image: url(gif_where.gif)
background-size: 700px
background-position: 50% 50%
