...
background-image: url(figs/r_modes.png)
background-size: 70%
...
background-image: url(figs/data_structures.png)
background-size: 450px
background-position: 50% 90%

---

background-image: url(figs/data_structures2.png)
...
background-image: url(figs/vector_math.jpg)
...
background-image: url(figs/vector_types.png)
background-size: 800px
background-position: 50% 50%
...
background-image: url(figs/vector_summary_tree.png)
...
background-image: url(figs/factor.png)
background-size: 70%
...
background-image: url(figs/list.png)
